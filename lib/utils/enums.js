...
(function (AccountType) {
    ...
    AccountType["Collection"] = "collection";
    AccountType["Waiting"] = "waiting";
    AccountType["Suspense"] = "suspense";
    AccountType["Change"] = "change";
    AccountType["Commission"] = "commission";
    AccountType["Collect"] = "collect";
    AccountType["Cantonment"] = "cantonment";
    AccountType["Technical"] = "technical";
    AccountType["Reconciliation"] = "reconciliation";
    AccountType["Cancel"] = "cancel";
    AccountType["Freeze"] = "freeze";
    AccountType["Voucher"] = "voucher";
    AccountType["Reliquat"] = "reliquat";
    AccountType["Autorization"] = "autorization";
    AccountType["PreAutorization"] = "pre-autorization";
    AccountType["CounterAutorization"] = "counter autorization";
    AccountType["CounterPreAutorization"] = "counter pre-autorization";
    AccountType["WaitingRefund"] = "waiting refund";
    AccountType["Disbursement"] = "disbursement";
    AccountType["Tva"] = "tva";
    AccountType["Hit"] = "hit";
...
(function (PayoutAutoFrequency) {
    ...
    PayoutAutoFrequency["OnCashing"] = "11";
...
(function (OperationType) {
    ...
    OperationType["PreAutho"] = "Pre-autho";
    OperationType["Unpaid"] = "Unpaid";
...
(function (InstantPayment) {
    InstantPayment["Expected"] = "EXPECTED";
})(InstantPayment || (InstantPayment = {}));
exports.InstantPayment = InstantPayment;
var IbanPaymentMethodKey;
(function (IbanPaymentMethodKey) {
    IbanPaymentMethodKey["SCT"] = "SCT";
    IbanPaymentMethodKey["SCTInst"] = "SCT INST";
})(IbanPaymentMethodKey || (IbanPaymentMethodKey = {}));
exports.IbanPaymentMethodKey = IbanPaymentMethodKey;
/**
...
(function (RequirementFileType) {
    ...
    RequirementFileType["SYND_ID"] = "SYND_ID";
    RequirementFileType["REPORT_GEN_SYND"] = "REPORT_GEN_SYND";
...
var HasCountryQuestionnaire;
(function (HasCountryQuestionnaire) {
    HasCountryQuestionnaire["Y"] = "Y";
    HasCountryQuestionnaire["N"] = "N";
    HasCountryQuestionnaire["NC"] = "NC";
})(HasCountryQuestionnaire || (HasCountryQuestionnaire = {}));
exports.HasCountryQuestionnaire = HasCountryQuestionnaire;
var Channel;
(function (Channel) {
    Channel["EPI"] = "EPI";
})(Channel || (Channel = {}));
...
(function (RequestStatus) {
    RequestStatus["ToValidate"] = "To validate";
    ...
    RequestStatus["Forced"] = "Forced";
    RequestStatus["ToCheck"] = "To check";
    RequestStatus["Created"] = "Created";
    RequestStatus["Analysis"] = "Analysis";
    RequestStatus["ToRead"] = "To read";
    RequestStatus["ToScore"] = "To score";
    RequestStatus["ToControl"] = "To control";
    RequestStatus["ToScreen"] = "To screen";
})(RequestStatus || (RequestStatus = {}));
exports.RequestStatus = RequestStatus;
/** Unsignificant amount flag. Possible values: 0 (default) Significant amount, 1 Unsignificant amount, adjusted when first payment received */
var UnsignificantAmount;
(function (UnsignificantAmount) {
    UnsignificantAmount["false"] = "0";
    UnsignificantAmount["true"] = "1";
})(UnsignificantAmount || (UnsignificantAmount = {}));
exports.UnsignificantAmount = UnsignificantAmount;
