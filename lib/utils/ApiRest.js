...
var ApiRest = /** @class */ (function () {
    ...
    ApiRest.prototype.sendAuthenticatedRequest = function (payload, isBase64) {
        ...
        if ((_a = ApiRest.authToken) === null || _a === void 0 ? void 0 : _a.isInvalidOrExpired) {
    ...
    ApiRest.prototype.buildHeaders = function () {
        var _a, _b;
        return {
            "Authorization": "Bearer ".concat((_a = ApiRest.authToken) === null || _a === void 0 ? void 0 : _a.tokenValue),
            "id_token": "".concat((_b = ApiRest.authToken) === null || _b === void 0 ? void 0 : _b.tokenId)
        };
    };
