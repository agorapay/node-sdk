...
declare enum TicketFormat {
    JSON = "J",
    PDF = "P"
}
declare enum TicketSide {
    DEBIT = "1",
    CREDIT = "2"
}
declare enum TicketMode {
    PROD = "PROD",
    TEST = "TEST"
}
...
declare enum AccountType {
    ...
    PreAutorization = "pre-autorization",
    CounterAutorization = "counter autorization",
    CounterPreAutorization = "counter pre-autorization",
    WaitingRefund = "waiting refund",
    Disbursement = "disbursement",
    Tva = "tva",
    Hit = "hit"
}
declare enum PaymentMethodKey {
    SDD = "SDD",
    SCT = "SCT",
    transfer = "transfer",
    card = "card",
...
declare enum PayoutAutoFrequency {
    Deactivate = "0",
    OnceADay = "1",
    OnceAWeek = "2",
    OnceAMonth = "3",
...
declare enum Role {
    ...
    RegulatedProfession = "PR"
}
declare enum OperationSide {
    Payin = "PAYIN",
    Payout = "PAYOUT"
}
 ...
 */
declare enum RequirementFileType {
    PASSPORT = "PASSPORT",
...
declare enum HasCountryQuestionnaire {
    Y = "Y",
    N = "N",
    NC = "NC"
}
...
declare enum UnsignificantAmount {
    false = "0",
    true = "1"
}
