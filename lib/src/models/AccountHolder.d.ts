...
declare class AccountHolder implements Encodable {
     ...
     */
    constructor(requirements: Array<Requirement>, physicalPersons: Array<PhysicalPersons>, accountNumber?: string, paymentMethodAlias?: string, requestId?: string, status?: RequestStatus | string);
    encode(): {
        [key: string]: any;
    };
}
