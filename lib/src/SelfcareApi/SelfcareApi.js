...
var SelfcareApi = /** @class */ (function (_super) {
    __extends(SelfcareApi, _super);
    function SelfcareApi() {
     ...
     * ````
     */
    SelfcareApi.prototype.init = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (success, reject) {
                        return _this.sendToApiPost('/selfcare/init', options).then(function (resp) {
