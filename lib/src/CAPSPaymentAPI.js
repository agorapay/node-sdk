...
class CAPSPaymentAPI {
     ...
     * @param logResponses
     */
    constructor(tokenUser, tokenPassword, tokenUrl, baseUrl, timeout = 0, debug = false, logResponses = false) {
        this.config = new Config_1.default(tokenUser, tokenPassword, tokenUrl, baseUrl, timeout, debug, logResponses);
    }
    operationApi() {
