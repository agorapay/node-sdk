 ...
 * @prop {string | undefined} reason
 * @prop {string | undefined} registerAlias
 * @prop {string | undefined} alias
 * @prop {UnsignificantAmount | undefined} unsignificantAmount
 */
interface PaymentIFrameOptions {
    ...
    /**  */
    registerAlias?: string;
    /** If the shopper uses an alias or wishes to set the label of the new alias (setting registerAlias to YES)" */
    alias?: Alias;
    /**  */
