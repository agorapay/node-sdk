...
declare class PayinApi extends ApiRest {
     ...
     * ````
     */
    paymentSecure(options: PaymentOptionsWithOrderId | PaymentOptionsWithoutOrderId): Promise<Payment>;
    /**
     ...
     * ````
     */
    paymentIframeSecure(options: PaymentIFrameOptions): Promise<PaymentIFrameResponse>;
    /**
