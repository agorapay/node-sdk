...
class PayinApi extends ApiRest_1.default {
    ...
    payment(options) {
        ...
        return this.sendToApiPost("/payin/payment", Object.assign(options, args))
            .then(result => new Payment_1.default(result));
    }
    /**
    ...
    orderDetails(orderId) {
        return this.sendToApiGet("/payin/orderDetails", { orderId: orderId })
            .then(result => new OrderDetails_1.default(result));
    }
    /**
    ...
    mandate(transactionId, reference) {
        return this.sendToApiGet("/payin/mandate", {
            ...
            .then(result => new SignedMandateFile_1.default(result));
    }
    /**
    ...
    ticket(transactionId, type, format, message) {
        return this.sendToApiGet("/payin/ticket", {
            ...
            .then(result => new Ticket_1.default(result));
    }
}
