...
var PayinApi = /** @class */ (function (_super) {
    ...
    PayinApi.prototype.payment = function (options) {
        ...
        return this.sendToApiPost("/payin/payment", Object.assign(options, args))
            .then(function (result) { return new Payment_1.default(result); });
    };
    /**
    ...
    PayinApi.prototype.paymentDetails = function (options) {
        return this.sendToApiPost("/payin/paymentDetails", options)
            .then(function (result) { return new Payment_1.default(result); });
    };
    /**
    ...
    PayinApi.prototype.paymentMethods = function (options) {
        return this.sendToApiPost("/payin/paymentMethods", options)
            .then(function (result) {
            var _a, _b;
            return ({
                paymentMethodList: (_b = (_a = result.paymentMethodList) === null || _a === void 0 ? void 0 : _a.map(function (method) { return new PaymentMethod_1.default(method.id, method.aliasList, method.label, method.type); })) !== null && _b !== void 0 ? _b : undefined,
    ...
    PayinApi.prototype.capture = function (options) {
        return this.sendToApiPost("/payin/capture", options)
            .then(function (result) {
            var _a;
            var status = Utils_1.default.hasEnumOrDefault(result.orderStatus, enums_1.OrderStatus, null);
            if (!result.orderId) {
            ...
            return {
                orderStatus: status,
                transactionList: ((_a = result.transactionList) !== null && _a !== void 0 ? _a : []).map(function (x) { return new Transaction_1.default(x); }),
                orderId: result.orderId
            };
        });
    };
    ...
    PayinApi.prototype.cancel = function (options) {
        return this.sendToApiPost("/payin/cancel", options)
            .then(function (result) {
            var _a;
            var status = Utils_1.default.hasEnumOrDefault(result.orderStatus, enums_1.OrderStatus, null);
            if (!result.orderId) {
    ...
    PayinApi.prototype.orderDetails = function (orderId) {
        return this.sendToApiGet("/payin/orderDetails", { orderId: orderId })
            .then(function (result) { return new OrderDetails_1.default(result); });
    };
    /**
    ...
    PayinApi.prototype.adjustPayment = function (options) {
        return this.sendToApiPost("/payin/adjustPayment", options)
    ...
    PayinApi.prototype.paymentIframe = function (options) {
        return this.sendToApiPost("/payin/paymentIframe", options)
            .then(function (result) {
    ...
    PayinApi.prototype.refund = function (options) {
        return this.sendToApiPost("/payin/refund", options)
            .then(function (result) {
            var _a, _b, _c;
            var status = Utils_1.default.hasEnumOrDefault(result.orderStatus, enums_1.OrderStatus, null);
            if (status === null) {
            ...
            return {
                orderStatus: Utils_1.default.hasEnumOrDefault(result.orderStatus, enums_1.OrderStatus, undefined),
                transactionList: (_b = (_a = result.transactionList) === null || _a === void 0 ? void 0 : _a.map(function (x) { return new Transaction_1.default(x); })) !== null && _b !== void 0 ? _b : undefined,
                orderId: (_c = result.orderId) !== null && _c !== void 0 ? _c : undefined
            };
        });
    };
    /**
    ...
    PayinApi.prototype.mandate = function (transactionId, reference) {
        return this.sendToApiGet("/payin/mandate", {
            ...
            .then(function (result) { return new SignedMandateFile_1.default(result); });
    };
    /**
    ...
    PayinApi.prototype.ticket = function (transactionId, type, format, message) {
        return this.sendToApiGet("/payin/ticket", {
            ...
            .then(function (result) { return new Ticket_1.default(result); });
    };
    return PayinApi;
}(ApiRest_1.default));
