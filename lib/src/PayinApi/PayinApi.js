...
var PayinApi = /** @class */ (function (_super) {
    ...
    PayinApi.prototype.paymentMethods = function (options) {
        return this.sendToApiPost("/payin/paymentMethods", options)
            ...
            var _a, _b;
            return ({
                paymentMethodList: (_b = (_a = result.paymentMethodList) === null || _a === void 0 ? void 0 : _a.map(function (x) { return new PaymentMethod_1.default(x); })) !== null && _b !== void 0 ? _b : undefined,
    ...
    PayinApi.prototype.refund = function (options) {
        return this.sendToApiPost("/payin/refund", options)
            ...
            return {
                ...
                orderId: Utils_1.default.hasIntegerOrDefault(result.orderId, undefined)
            };
        });
    };
    /**
