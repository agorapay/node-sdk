...
/**
 * @prop {Array<paymentAccountList>} paymentAccountList
 */
...
/** Set authorized OverDraft Amount */
interface PaymentAccountSetAuthorizedOverdraftRequest {
    /** A string representing the account number. */
    accountNumber: string;
    /**
     * The value of the authorized overdraft amount, in decimal with max 2 digits after separator.
     * Only digits and dot are authorized.
     * @minLength 1
     * @maxLength 16
     * @pattern ^[0-9]{1,13}([.][0-9]{1,2})?$
     */
    authorizedOverdraftAmount: string;
    /** Currency code in 3 characters ISO format */
    currency: string;
}
export { PaymentAccountListOptions, PaymentAccountListResponse, PaymentAccountCreditOptions, PaymentAccountCreditResponse, PaymentAccountPayoutAutoOptions, PaymentAccountSetIBANOptions, PaymentAccountSetIBANResponse, PaymentAccountSetAuthorizedOverdraftRequest };
