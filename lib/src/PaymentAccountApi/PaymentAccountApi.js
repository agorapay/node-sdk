...
var PaymentAccountApi = /** @class */ (function (_super) {
            ...
            return _this.sendToApiPost('/paymentAccount/list', options).then(function (resp) {
                ...
                try {
                    success({
                        ...
                        paymentAccountList: (_b = (_a = resp.accountList) === null || _a === void 0 ? void 0 : _a.map(function (x) { return new PaymentAccount_1.default(x); })) !== null && _b !== void 0 ? _b : []
                    });
                }
                catch (err) {
                    reject(err);
    ...
    PaymentAccountApi.prototype.setIBAN = function (options) {
        var _this = this;
        return new Promise(function (success, reject) {
            return _this.sendToApiPost('/paymentAccount/setIBAN', options, true).then(function (resp) {
                if (+resp.resultCode !== 0)
                    reject(new Error("".concat(resp.resultCode, " - ").concat(resp.resultCodeMessage)));
                try {
                    success({
