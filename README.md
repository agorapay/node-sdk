...
| /payin/paymentSecure          | Payin.paymentSecure(options: PaymentOptionsWithOrderId, PaymentOptionsWithoutOrderId) | POST
...
| /payin/paymentIframeSecure    | Payin.paymentIframeSecure(options: PaymentIFrameOptions)                              | POST
...
| /paymentAccount/setAuthorizedOverdraft   | PaymentAccount.setAuthorizedOverdraft(options: PaymentAccountSetAuthorizedOverdraftRequest)       | POST
...
| /accountHolder/onlineRegister      | AccountHolder.onlineRegister(options: OnlineRegisterAccountHolderOptions)       | POST
